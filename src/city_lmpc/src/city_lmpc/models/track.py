...
class Track():
    ...
    def __init__(self, arcs: List[Union[ArcByLength, ArcByAngle]], x_s0=0, y_s0=0, phi_s0=0, flip=False, diff=0, POINT_DENSITY=1000):
        # self.arcs = [ArcByLength(0, 1.35 + diff)] + arcs + [ArcByLength(0, 1.35 - diff)]
        self.arcs = arcs
        self.x_s0 = x_s0
        self.y_s0 = y_s0
        self.phi_s0 = phi_s0
    ...
    def _create_transformation_components(self):
        R = np.array([[cos(self.phi_s0), -sin(self.phi_s0)],
