...
class SVEAManager(object):
    ...
    @property
    def rc_remote_log(self):
        """Returns stored list of RC remote inputs"""
        return self.actuation.remote_log

    def send_control(self, steering, velocity, transmission=0):
        ...
        :type velocity: float
        """
        self.actuation.send_control(steering, velocity, transmission=0)
        # log control as soon as it's actually sent
        self.data_handler.log_ctrl(steering, velocity, transmission, rospy.get_time())
